      ...
      decoration: InputDecoration(
        ...
        suffixIcon: Padding(
          padding: const EdgeInsets.only(
              right: appDefaultPadding / 2), // Padding for the suffix icon.
          child: IconButton(
        ...
        contentPadding: const EdgeInsets.only(
          ...
          bottom:
              appDefaultPadding, // Padding on the bottom inside the TextField.
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(
              appDefaultPadding / 2), // Border radius when enabled.
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(
              appDefaultPadding / 2), // Border radius when focused.
        ),
      ),
    );
  }
